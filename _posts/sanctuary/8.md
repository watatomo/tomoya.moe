...
(Urgh... I got so hungry that we ended up using whatever was in the fridge...)<Fn num="1">You can read the cooking scene itself in <a href="/tl/sanctuary/mini_talk/tomoya/2">Tomoya's rare Mini Talk</a>.</Fn>
...
So skills related to your unconscious memory are still intact, but you don't have any—what's it called—episodic memory...?<Fn num="2">Tomoya is talking about <a href="https://en.wikipedia.org/wiki/Procedural_memory">procedural memory</a> here, a kind of unconscious (implicit) memory that helps you perform skills and actions without thinking. Wataru doesn't have any <a href="https://en.wikipedia.org/wiki/Episodic_memory">episodic memory</a>, which is any memory that involves his past experiences. It's a type of conscious (explicit) memory.</Fn>
...
I have no idea what's going on. I also heard stuff about other units being trapped in weird places like a desert or a jungle...<Fn num="3">Alluding to <i><a href="https://yoroshikilled.dreamwidth.org/10838.html">Satellite</a></i> and <i><a href="https://fortunebanquet.tumblr.com/post/659604958452367360/sandstormprologue">Sandstorm</a>.</i></Fn>
...
1. You can read the cooking scene itself in [Tomoya's rare Mini Talk](/tl/sanctuary/mini_talk/tomoya/2).
2. Tomoya is talking about <a href="https://en.wikipedia.org/wiki/Procedural_memory">procedural memory</a> here, a kind of unconscious (implicit) memory that helps you perform skills and actions without thinking. Wataru doesn't have any <a href="https://en.wikipedia.org/wiki/Episodic_memory">episodic memory</a>, which is any memory that involves his past experiences. It's a type of conscious (explicit) memory.
3. Alluding to <i><a href="https://yoroshikilled.dreamwidth.org/10838.html">Satellite</a></i> and <i><a href="https://fortunebanquet.tumblr.com/post/659604958452367360/sandstormprologue">Sandstorm</a>.</i>
