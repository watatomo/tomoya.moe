...
<Thought>(Urgh... I got so hungry that we ended up using whatever was in the fridge...)<Fn num="1">You can read the cooking scene itself in <a href="/tl/sanctuary/mini_talk/tomoya/2">Tomoya's rare Mini Talk</a>.</Fn></Thought>
...
So skills related to your implicit memory are still intact, but you don't have any—what's it called—episodic memory...?<Fn num="2">Tomoya is talking about <a href="https://en.wikipedia.org/wiki/Procedural_memory">procedural memory</a> here, a type of implicit memory that helps you perform skills and actions without thinking. Wataru doesn't have any <a href="https://en.wikipedia.org/wiki/Episodic_memory">episodic memory</a>, which is any memory that involves his past experiences. It's a type of explicit memory.</Fn>
