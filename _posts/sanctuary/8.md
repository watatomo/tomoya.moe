...
So skills related to your implicit memory are still intact, but you don't have any—what's it called—episodic memory...?<Fn num="2"><a href='https://en.wikipedia.org/wiki/Episodic_memory'>Episodic memory</a> is a kind of explicit memory that involves the memory of past experiences. The type of implicit memory Tomoya is specifically referring to is called <a href='https://en.wikipedia.org/wiki/Procedural_memory'>procedural memory</a>, which helps one perform skills and actions without thinking.</Fn>
