...
So skills related to your implicit memory are still intact, but you don't have any—what's it called—episodic <span className="hold">memory...?<Fn num="2">[Episodic memory](https://en.wikipedia.org/wiki/Episodic_memory) is a kind of explicit memory that involves the memory of past experiences. The type of implicit memory Tomoya is specifically referring to is called [procedural memory](https://en.wikipedia.org/wiki/Procedural_memory), which helps one perform skills and actions without thinking.</Fn></span>
...
That aside, err... What does it <span className="hold">say—</span>
