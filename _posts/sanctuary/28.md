...
description: "Tori: We're friends who came together for the same hobby, for the same love, and that's not gonna go away. At least, that's what I want to believe."
story: "sanctuary"
series: "enst"
previous: 27
next: 29
...
Gate...keeper? Are they from another country or somethin'?
...
<Thought>{`(So I have to follow the Secret Order and not tell anyone where Anzu is.)`}</Thought>
...
<Thought>{`(As long as Tomo-chin isn't the one to spill the beans, it might be <span className="hold">okay—)</span>`}</Thought>
...
Anyway, I heard about everything from Gatekeeper yesterday at the hotel he booked for me.
...
The mysterious old couple<Fn num="1">It's been speculated that this old couple is Wataru's (foster) parents.</Fn> who helped us out during Bogie Time took care of me.
...
<Thought>{`(Gatekeeper is shady as hell, but the bulk of it was explained by Anzu since she was there too—and she's someone that we can definitely trust.)`}</Thought>

<Thought>{`(It's annoying that I can't tell anyone else about me seeing her. I'd like to try and sneak the info over to Mako-chin <span className="hold">somehow—)</span>`}</Thought>

</Bubble>

<Image src="/img/tl/sanctuary/28/2.jpg" alt="Chapter image 2" layout="responsive" width="1560" height="720" quality="100" />
...
Sorry, but I don't think it's our fault. You're just letting your guard down too much, right?
...
Oh, right. Both of you were in the tennis club at Yumenosaki. I guess that's why you're so friendly with each other.
...
I'd like to think it's the same for our seniors too. Right now we're rivals competing against each other in SS, but it's not like we _hate_ each other&NoBreak;—
...
1. [↑](#fnref:1) It's been speculated that this old couple is Wataru's (foster) parents.
