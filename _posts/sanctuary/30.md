...
I see. So then SANCTUARY is a facility for operant conditioning<Fn num="1">Operant conditioning is basically what Nazuna said. It's a kind of learning that employs rewards and punishments for behavior. In this example, Eichi uses positive reinforcement: with happiness as the reinforcer (reward) to guide people towards becoming an idol—the desired behavior.</Fn>—for "teaching" people that.
...
1. [↑](#fnref:1) Operant conditioning is basically what Nazuna said. It's a kind of learning that employs rewards and punishments for behavior. In this example, Eichi uses positive reinforcement: with happiness as the reinforcer (reward) to guide people towards becoming an idol—the desired behavior.
