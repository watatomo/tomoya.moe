...
yes! it'll be as easy as cheezumi\~<Fn num="1">Kanata's original pun is "izumi in the bag," a play on the Japanese word for rat/mouse, "nezumi."</Fn>
...
yes, so we're basically playing a game of <span className="hold">"tag"~♪</span>
...
if that's the case, then it's "reasonable" that you couldn't sleep. could it be that you're being extra aggressive today because you didn't get enough "sleep" and don't have "room to <span className="hold">breathe"? ♪</span>
...
Ahaha. I don't think it'll actually escalate to become life-threatening, though. The zombies don't seem to listen to anything we say to <span className="hold">them—</span>
