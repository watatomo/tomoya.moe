        ...
        >
          <div className="yuukun-songBackground" data-depth="0.5">
            {SONG_INFO.SINGERS.map((e, i) => {
              if (i == 0 || i == 3) {
                return (
                  <div data-singer={e.id} key={i} className="abwybg">
                    <Image
                      key={e.id}
                      src={e.image}
                      alt={e.name}
        ...
        <div className="yuukun-song">
          <div className="yuukun-songInfo">
            ...
            <div className="yuukun-trackInfo">
              <span className="yuukun-trackInfo__title">{SONG_INFO?.NAME}</span>
            ...
            lineRenderer={({ index, active, line }) => (
              ...
              >
                <span className="yuukun-lyrics__singerIndicator">
                  {SONG_INFO.LINES[index].singer.map((e, i) => (
                    // console.log(e);
                    <span
                      key={i}
                      style={{
                ...
                <span className="yuukun-lyrics__translatedLine">
                  {SONG_INFO.LINES[index].lines[currentLanguage]}
                </span>
              </span>
            )}
          ...
          <div className="yuukun-audioPlayer">
            <div className="yuukun-singer">
              {SONG_INFO.SINGERS.map((e, i) => {
                ...
                if (
                  currentLine !== -1 &&
                  SONG_INFO.LINES[currentLine].singer.includes(i)
                ) {
                  isSinging = "singing";
                }
                return (
                  <div data-singer={e.id} key={i} className={isSinging}>
                    <Image
                      key={e.id}
                      src={e.image}
                      alt={e.name}
